...
if(class_exists('CmsShortCode')){
	vc_map(
		array(
			"name" => esc_html__("CMS Countdown", 'wp-trust'),
		    "base" => "cms_countdown",
		    ...
		    "params" => array(
		        array(
	            "type" => "textfield",
	            "heading" => esc_html__("Date count down",'wp-trust'),
	            "param_name" => "date_count_down",
	            "value" => "",
	            "description" => esc_html__("Set date count down (default:2020/10/10)",'wp-trust'),
	            "group" => esc_html__("General Settings", 'wp-trust')
		        ),
		    	array(
		            "type" => "cms_template",
