jQuery( document ).ready(function($) {
	...
	var count_down = el.getAttribute("data-count-down");
 	...
 	$('#getting-started').countdown(count_down, function(event) {
     	...
     	+ '<div class="col-xs-12 col-sm-6 col-md-3"><div class="countdown-item-container"><span class="countdown-amount">%H</span><span class="countdown-period">Hours</span></div></div>'
