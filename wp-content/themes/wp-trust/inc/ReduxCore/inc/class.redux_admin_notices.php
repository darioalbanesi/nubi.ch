                        ...
                        if ( true == $notice['dismiss'] ) {
                            ...
                            if ( ! get_user_meta( $userid, 'ignore_' . $notice['id'] ) ) {
                                ...
                                if ( version_compare( $wp_version, '4.2', '>' ) ) {
                                    ...
                                    echo '<div ' . $add_style . ' class="' . esc_attr( $notice['type'] ) . ' notice is-dismissable"><p>' . wp_kses_post( $notice['msg'] ) . '&nbsp;&nbsp;<a href="?dismiss=true&amp;id=' . esc_attr( $notice['id'] ) . $pageName . $curTab . '">' . esc_html__( 'Dismiss', "wp-experts" ) . '</a>.</p></div>';
                                }
                            }
                        } else {
                            // Standard notice
