    ...
    class ReduxFramework_select {
        ...
        public function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : __( 'Select an item', "wp-experts" );
                ...
                echo '<strong>' . __( 'No items of this type were found.', "wp-experts" ) . '</strong>';
            }
        } //function
