...
<div id="cshero-header-inner" class="header-8 header-center">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <?php if ( is_active_sidebar( 'header-default-left' ) ) { ?>
                        <div class="header-center-contact col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center hidden-xs hidden-sm"><?php dynamic_sidebar('header-default-left'); ?></div>
                    <?php } ?>
