...
<div id="cshero-header-inner" class="header-7 header-center">
    <?php if ( is_active_sidebar( 'header-default-left' ) || is_active_sidebar( 'header-default-right' ) ) { ?>
        <div id="cshero-header-top" class="hidden-xs hidden-sm">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-center-md"><?php dynamic_sidebar('header-default-left'); ?></div>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-center-md"><?php dynamic_sidebar('header-default-right'); ?></div>
                </div>
            </div>
        </div>
    <?php } ?>
    ...
    <div id="cshero-header-wrapper">
        <div id="cshero-header" class="cshero-main-header <?php if (!empty($wp_trust_meta->_cms_one_page)) {echo 'active-menu-onepage';} ?> <?php if (!$smof_data['menu_sticky']) {echo 'no-sticky';} ?>">
            <div class="container">
                <div class="row">
                    <div id="cshero-header-navigation" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center <?php if ( is_active_sidebar( 'search' ) ) { echo 'search-active';} ?>">
