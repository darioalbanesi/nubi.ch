...
<div id="cshero-header-inner" class="header-12 h-style bg-trans">
                ...
                <div class="row">
                    <div id="cshero-header-logo" class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                        ...
                        <a href="<?php echo esc_url(home_url('/')); ?>">
                            ...
                            <span><?php  esc_html_e('Kompetenz vom Entwurf bis zur Unterschrift','wp-trust'); ?></span>
                        </a>
                    </div>
                    <div id="cshero-header-navigation" class="col-xs-12 col-sm-7 col-md-7 col-lg-7 <?php if ( !is_active_sidebar( 'header-default-left' ) ) { echo 'header-top-acitve'; } ?>">
                        <?php if ( is_active_sidebar( 'header-default-left' ) ) { ?>
                            <div class="cshero-navigation-widget-top text-right gray hidden-xs hidden-sm">
                                <?php dynamic_sidebar('header-default-left'); ?>
                            </div>
                        <?php } ?>
