    ...
    <main id="main" class="site-main" role="main">    
        <div class="<?php echo get_post_meta(get_the_ID(), 'cs_layout', true) ? 'no-container' : 'container'; ?>">
            <div class="row">
                ...
                <div class="<?php echo ( is_active_sidebar('woocommerce-widget-area') && (isset( $_GET['has_sidebar'] ) && $_GET['has_sidebar'] == 'true' ) ) ? 'col-xs-12 col-sm-9 col-md-9 col-lg-9 sidebar-active' : 'col-xs-12 col-sm-12 col-md-12 col-lg-12 pr-full-width'; ?>">
                	<?php
                		/**
                ...
                <?php if (isset( $_GET['has_sidebar'] ) && $_GET['has_sidebar'] == 'true' ) : ?>
