...
if ($products->have_posts()) :
    ...
    <div class="woo-nav-links">
        <ul>
            <?php
                previous_post_link( '<li class="nav-previous">%link</li>', '<span><i class="page-numbers fa fa fa-long-arrow-left"></i></span>' );
                next_post_link(     '<li class="nav-next">%link</li>',     '<span><i class="page-numbers fa fa fa-long-arrow-right"></i></span>' );
            ?>
        </ul>
    </div><!-- .nav-links -->
    <div id="cms-related-product-<?php echo esc_attr($date); ?>" class="cms-related-products-wrapper clearfix">
        <div class="cms-related-heading">
            <h3 class="wg-title"><span><?php esc_html_e('Related Products', 'woocommerce'); ?></span></h3>
        </div>
        <div class="products">
                    ...
                    <div <?php post_class('pb-40 cms-product text-center'); ?>>
                        ...
                        <div class="cshere-woo-item-wrap" onclick="">
                            ...
                            <div class="cshero-woo-meta">
                                <?php echo $product->get_categories( ', ', '<span class="product-meta-inner posted_in">' . _n( '', '', $cat_count, 'woocommerce' ) . ' ', '.</span>' ); ?>
