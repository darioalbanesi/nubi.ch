...
<form class="variations_form cart" method="post" enctype='multipart/form-data' data-product_id="<?php echo ''.$post->ID; ?>" data-product_variations="<?php echo esc_attr( json_encode( $available_variations ) ) ?>">
						...
						<div class="variations-item clearfix">
							...
							<div class="value clearfix"><span class="arrow-down"><i class="fa fa-angle-down"></i>
								...
								if ( sizeof( $attributes ) === $loop ) {
									echo '<a class="reset_variations" href="#reset">' . esc_html__( 'Clear selection', 'wp-trust' ) . '</a>';
								}
							?></div>
						</div>
		        <?php endforeach;?>
	...
	<?php else : ?>
		...
		<p class="stock out-of-stock"><?php esc_html_e( 'This product is currently out of stock and unavailable.', 'wp-trust' ); ?></p>
