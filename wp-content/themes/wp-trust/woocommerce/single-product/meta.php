...
<div class="cshero-product-meta">
	<span class="share-label"><?php esc_html_e('Share product: ', 'wp-trust'); ?></span>
	...
	<a target="_blank" href="https://twitter.com/home?status=<?php esc_html_e('Check out this article', 'wp-trust');?>:%20<?php the_title();?>%20-%20<?php the_permalink();?>"><span class="share-box"><i class="fa fa-twitter"></i></span></a>
