...
?>
<div class="cms-fancyboxes-wraper cms-fancyboxes-deault <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <?php if($atts['title']!=''):?>
        ...
        <div class="cms-fancybox-item">
            ...
            <?php if($atts['title_item']):?>
                ...
                <h3 class="cms-fancybox-title">
                    ...
                    <span class="order-box"><?php echo esc_attr($cms_fancybox_order_box);?>.</span>
                </h3>
            <?php endif;?>
