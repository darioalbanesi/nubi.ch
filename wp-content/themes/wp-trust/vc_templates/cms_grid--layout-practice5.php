...
?>
<div class="layout-practice practice-layout4 icon-style1 filtrer-center cms-grid-wraper <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
