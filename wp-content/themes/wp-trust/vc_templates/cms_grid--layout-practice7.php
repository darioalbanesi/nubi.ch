...
?>
<div class="layout-practice practice-layout2 practice-layout7 filtrer-center cms-grid-wraper <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
