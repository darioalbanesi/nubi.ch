...
?>
<div class="layout-practice practice-layout3 practice-layout8 filtrer-center cms-grid-wraper <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
        ...
        while($posts->have_posts()){
            ...
            <div class="cms-grid-item cms-practice-item <?php echo esc_attr($atts['item_class']);?>" data-groups='[<?php echo implode(',', $groups);?>]'>
                <div class="cms-grid-item-inner">
                    ...
                    <div class="cms-practice-content  content-hover text-center">
                        <div class="cms-practice-icon">
                            <i class="<?php echo  esc_attr($practice_icon); ?>"></i>
                        </div>
                        <h3 class="cms-practice-title">
                        ...
                        <div class="cms-practice-readmore">
                            <a class="btn btn-primary btn-lg" href="<?php the_permalink() ?>" ><?php esc_html_e('Read More', 'wp-trust'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
