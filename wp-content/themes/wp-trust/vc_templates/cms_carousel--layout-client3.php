...
?>
<div class="cms-carousel cms-carousel-client cms-carousel-client-layout3 <?php echo esc_attr($navigation_align); ?> <?php if($navigation_horizontal_center == 'yes') { echo 'navigation-horizontal-center'; } ?> <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <?php
    $posts = $atts['posts'];
