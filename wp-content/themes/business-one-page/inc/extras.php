...
function business_one_page_footer_credit(){
    ...
    $text .= sprintf( esc_html__( 'Theme by: %s', 'business-one-page' ), '<a href="' . esc_url( __( 'http://raratheme.com/', 'business-one-page' ) ) .'" rel="designer">Rara Theme</a> &middot; ' );
    $text .= sprintf( esc_html__( 'Powered by: %s', 'business-one-page' ), '<a href="'. esc_url( __( 'https://wordpress.org/', 'business-one-page' ) ) .'">WordPress</a>' );
    $text .= '</div>';
