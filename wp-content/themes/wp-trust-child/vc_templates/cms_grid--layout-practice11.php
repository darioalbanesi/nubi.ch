...
?>
<div class="layout-practice practice-layout11 filtrer-center cms-grid-wraper <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
                ...
                <div class="cms-grid-item-inner">
                    <div class="cms-practice-image b-ra">
                        ...
                        <div class="cms-practice-content">
                            <div class="cms-practice-content-main">
                        ...
                        <div class="cms-practice-content-hover  text-center">
                            <div class="cms-practice-content-inner">
                                <?php echo  substr(esc_attr($practice_introduction),0,90); ?>
                            </div>
