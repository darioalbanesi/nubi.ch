...
?>
<div class="layout-practice practice-layout9 filtrer-center cms-grid-wraper <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
        ...
        while($posts->have_posts()){
            ...
            <div class="cms-grid-item cms-practice-item <?php echo esc_attr($atts['item_class']);?>" data-groups='[<?php echo implode(',', $groups);?>]'>
                <div class="cms-grid-item-inner">
                    <div class="cms-practice-content text-center">
                        ...
                        <div class="cms-practice-content-inner">
                            <?php echo  substr(esc_attr($practice_introduction),0,110); ?>
                        </div>
                    </div>
                </div>
            </div>
