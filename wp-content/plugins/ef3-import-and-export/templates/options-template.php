        ...
        <table class="ef3-server-info">
            <tr>
                ...
                <?php if($memory_limit >= 128): ?>
                    ...
                    <td><?php echo sprintf(esc_html__('Currently: %s', ''), $memory_limit); ?></td>
                <?php else: ?>
                    <td><i class="el el-remove-circle"></i></td>
                    <td style="color: #D50000"><?php echo sprintf(esc_html__('Currently: %s (the minimum required 128M)', ''), $memory_limit); ?></td>
                <?php endif; ?>
            </tr>
            <tr>
                ...
                <?php if($max_time >= 60): ?>
                    <td><i class="el el-check"></i></td>
                    <td><?php echo sprintf(esc_html__('Currently: %s', ''), $max_time); ?></td>
                <?php else: ?>
                    <td><i class="el el-remove-circle"></i></td>
                    <td style="color: #D50000"><?php echo sprintf(esc_html__('Currently: %s (the minimum required 60s)', ''), $max_time); ?></td>
                <?php endif; ?>
            </tr>
            <tr>
                ...
                <?php if($post_max_size >= 32): ?>
                    <td><i class="el el-check"></i></td>
                    <td><?php echo sprintf(esc_html__('Currently: %s', ''), $post_max_size); ?></td>
                <?php else: ?>
                    <td><i class="el el-remove-circle"></i></td>
                    <td style="color: #D50000"><?php echo sprintf(esc_html__('Currently: %s (the minimum required 32M)', ''), $post_max_size); ?></td>
                <?php endif; ?>
            </tr>
        </table>
    </p>
...
<?php if(apply_filters('ef3-enable-create-demo', false)): ?>
