...
if (!class_exists('EF3_Import_Export')) :
    ...
    final class EF3_Import_Export
    {
        ...
        function get_option_layout(){
            ...
            wp_enqueue_script('enscroll' , $this->acess_url . 'enscroll-0.6.2.min.js');
        ...
        function ajax_inport(){
            ...
            if(empty($_REQUEST['id']) && empty($_REQUEST['import']))
                exit();
            ...
            switch ($_REQUEST['import']) {
                ...
                /* import options */
                case 'options':
                    $response = ef3_options_import($folder_dir . 'options.json');
                    break;
                /* import post type */
                case 'ctp_ui':
                ...
                /* import content */
                case 'content':
                    $response = ef3_content_import($folder_dir);
                    break;
                /* revslider import */
                case 'revslider':
